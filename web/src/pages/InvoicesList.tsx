    ...
    <div className="flex">
      ...
      <div className="w-16 bg-white border-r border-gray-200 flex flex-col">
        <div className="p-2 space-y-2">
          ...
          <button onClick={() => navigate('/owner-track')} className="w-12 h-12 flex items-center justify-center hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors" title="Owner Track">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredInvoices.map((invoice) => (
                    <tr key={invoice.id} className="hover:bg-gray-50">
                      <td className="px-6 py-3 whitespace-nowrap text-xs font-medium text-gray-900">{invoice.invoice_no}</td>
                      <td className="px-6 py-3 whitespace-nowrap text-xs text-gray-500">{invoice.report_id}</td>
                      <td className="px-6 py-3 whitespace-nowrap text-xs text-gray-900">${(Number(invoice.amount) || 0).toFixed(2)}</td>
